...
import org.warcbase.mapreduce.lib.Chain.ChainBlockingQueue;
...
public class TableChainMapper<KEYIN, VALUEIN, KEYOUT, VALUEOUT> extends TableMapper<Text, Text> {
  ...
  public static void addMapper(Job job, Class<? extends Mapper> klass,
    ...
    job.setMapperClass(TableChainMapper.class);
    job.setMapOutputKeyClass(outputKeyClass);
    job.setMapOutputValueClass(outputValueClass);
    Chain.addMapper(job, klass, inputKeyClass, inputValueClass,
