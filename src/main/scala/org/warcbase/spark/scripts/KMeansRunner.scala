...
import org.apache.spark.mllib.clustering.{LDA, KMeansModel, KMeans}
...
object KMeansRunner {
  def apply(records: RDD[ArchiveRecord], sc: SparkContext, k: Int = 20, numIterations: Int = 20) = {
    ...
    new KMeansResult(KMeans.train(tfidf, k, numIterations), tfidf)
  }
